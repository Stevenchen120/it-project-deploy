    ...
    <div class="container">
      ...
      <div class="form-container">
        ...
        <form @submit.prevent="handleRegister">
          ...
          <button v-on:click="passwordReset" type="submit">Submit</button>
        </form>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    passwordReset() {
      ...
      const re_new_password = this.confirmPassword.trim();
      const new_password = this.password.trim();
      if (new_password !== re_new_password) {
        showMessage("Two passwords are inconsistent", "error");
        return;
      }
      const formData = {
        uid: uid,
      ...
      axios
        ...
        .then((response) => {
          showMessage("Password reset successful", "info", () => {
            this.$router.push({
              name: "Login",
            });
          });
